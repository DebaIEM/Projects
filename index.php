...
<html lang="en">
  <head>
    ...
    <title>Stay With Platinum</title>
    <link rel = "icon" href = 
"./assets/img/home_icon.png" 
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="./assets/img/home_icon.png"width="100px"height="100px">Stay With Platinum</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./auth/register.php">Sign Up (Only For Owner)</a>
            </li>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">It feels so happy to see you again.</div> 
                        ...
                        <div class="card-block">';
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              echo '<p><b>Vacant For: </b>'.$value['sex'].'</p>';
                          ...
                          echo '</div>
                            ...
                            <h4 class="text-center">Room Details</h4>';
                              ...
                              if ($value['map']){
                                echo '<iframe class="mb-4 mb-lg-0" src="'.$value['map'].'" frameborder="0" style="border:0; width: 165%; height: 350px;" allowfullscreen></iframe>';
                              }
                          echo '</div>
                            <div class="col-3">
                            <h4>Other Details</h4>';
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Deba &copy; Stay With Platinum 2023</span>
          </div>
          <div class="col-md-4">
